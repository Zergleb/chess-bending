...
clojure.browser.event.IEventType = (function (){var obj34359 = {};
return obj34359;
})();
...
return (function (){var or__24663__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__25299__auto__)]);
if(or__24663__auto__){
return or__24663__auto__;
} else {
var or__24663__auto____$1 = (clojure.browser.event.event_types["_"]);
...
var k = cljs.core.nth.call(null,vec__34363,(0),null);
var v = cljs.core.nth.call(null,vec__34363,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
